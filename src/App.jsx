...
const SUMMARIES = {
  groupA: [
    "此應徵者似乎具備數位內容相關學歷與豐富的平面及介面設計經驗，可能曾擔任資深設計長，或許擁有跨部門溝通協調的實務經驗。",
    "此應徵者似乎為美工印刷背景，大概擁有長期經營廣告設計事業的資歷，近期可能負責文字編排與插圖設計相關工作。",
    "此應徵者似乎為媒體設計背景，可能具備商業粉專美編與自由接案經驗，大概熟悉文字編排與平面插圖設計。",
    "此應徵者似乎具備傳播學歷與設計總監經驗，或許擁有硬體產品包裝設計專長，大概兼具專利獎項與跨部門流程優化能力。",
  ],
  groupB: [
    "此應徵者似乎具備數位內容相關學歷與豐富的平面及介面設計經驗，可能曾擔任資深設計長，或許擁有跨部門溝通協調的實務經驗。",
    "此應徵者似乎為美工印刷背景，大概擁有長期經營廣告設計事業的資歷，近期可能負責文字編排與插圖設計相關工作。",
