...
const SUMMARIES = {
  groupA: [
    "此應徵者具備數位內容相關學歷與豐富的平面及介面設計經驗，曾擔任資深設計長，並擁有跨部門溝通協調的實務經驗。",
    "此應徵者為美工印刷背景，擁有長期經營廣告設計事業的資歷，近期並負責文字編排與插圖設計相關工作。",
    "此應徵者為媒體設計背景，具備商業粉專美編與自由接案經驗，熟悉文字編排與平面插圖設計。",
    "此應徵者具備傳播學歷與設計總監經驗，擁有硬體產品包裝設計專長，並兼具專利獎項與跨部門流程優化能力。",
  ],
  groupB: [
    "此應徵者具備數位內容相關學歷與豐富的平面及介面設計經驗，曾擔任資深設計長，並擁有跨部門溝通協調的實務經驗。",
    "此應徵者為美工印刷背景，擁有長期經營廣告設計事業的資歷，近期並負責文字編排與插圖設計相關工作。",
