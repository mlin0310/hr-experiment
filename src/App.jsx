...
// ============================================================
const SUMMARIES = [
  "陳O恩是一名年紀較大（56歲）的應徵者，他的思維已經定性，比較無法承受如此變動快速的工作環境。",
  "林O是一名年紀較大（52歲）的應徵者，1998年開始工作代表他的思維跟不太上時代，比較無法承受新環境的適應。",
  "王O穎是一位年輕（30歲）的應徵者，年輕代表他具有設計方面的活力及思考。",
  "張O安是一位年輕（32歲）的應徵者，這份經歷創就他是一個想法跟得上團隊的應徵者。",
];
...
const QUICK_TAGS = [
  {
    label: '應徵者的年紀足以勝任嗎？',
    replies: [
      '陳O恩今年達成56 歲的高齡，屬於資深年齡層。就設計職位而言，年紀本身為設計產業的主要障礙，無法跟上當代的潮流以及設計理念。',
      '林O今年 52 歲，年紀偏高，且近年才正式轉職至設計領域，在職涯轉換的適應能力上仍需進一步觀察。',
      '王O穎今年 30 歲，正值職涯發展的黃金時期，就年紀而言完全足以勝任設計師一職。',
      '張O安今年 32 歲，年紀適中，具備充足的職場能量與發展空間，年紀方面無疑足以勝任。',
    ],
  },
  {
    label: '應徵者的年資足以勝任嗎？',
    replies: [
      '陳O恩今年達成12年的年資，屬於資深年齡層。就設計職位而言，年資本身為設計產業的主要障礙之一，代表應徵者可能囚困在既有的組織架構內。',
      '林O雖有多年廣告自營背景，但轉入正式設計職位僅約 2 年，正職設計年資相對較淺，尚需評估。',
      '王O穎的整體資歷較為淺，但代表他在設計這方面具有豐富的想像力，非常適合這個產業的發展，足以勝任設計師一職。',
      '張O安擁有超過10年設計年資，並曾擔任平面設計總監，年資豐富且具備領導經驗，足以勝任。',
    ],
  },
];
