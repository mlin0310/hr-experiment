...
const SUMMARIES = {
  groupA: [
    "此應徵者具備數位內容相關碩士學歷與三年 UI/UX 設計經驗，熟悉設計系統與使用者研究流程。",
    "此應徵者擁有五年以上視覺設計經驗，專長品牌識別設計，具備良好的跨部門溝通能力。",
    "此應徵者為工業設計背景，具有新創公司產品設計經驗，擅長 3D 建模與快速原型製作。",
    "此應徵者擁有設計碩士學位與管理經驗，曾帶領設計團隊負責大型電商平台的用戶體驗優化。",
  ],
  groupB: [
    "此應徵者具備數位內容相關碩士學歷與三年 UI/UX 設計經驗，熟悉設計系統與使用者研究流程。",
    "此應徵者擁有五年以上視覺設計經驗，專長品牌識別設計，具備良好的跨部門溝通能力。",
