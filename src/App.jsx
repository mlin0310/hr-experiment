...
// ============================================================
const SUMMARIES = [
  "誒...此應徵者年紀應該...已經太大（56歲），思維...已經定型。",
  "嗯...此應徵者年紀太大（52歲），應該...難以適應新環境...吧？",
  "此應徵者年輕（30歲），應該...具有良好的心態...對吧？",
  "此應徵者年輕（32歲），想法或許...跟得上團隊...？",
];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="modal-card animate-fade-in-up">
            ...
            <div className="space-y-4 text-gray-900 leading-relaxed mb-8 text-base font-medium">
              ...
              <p>畫面左方為本次系統測試的<strong>任務提醒</strong>，提示「您所擔任的角色」與「每位候選人的提問限制」。</p>
              <p>畫面中間呈現候選人的履歷，<span style={{ color: '#8b0000' }}>請先閱讀履歷內容，再進行提問的動作</span>。</p>
              <p>畫面右方為對話區塊，供您針對候選人資訊進行提問，而每位候選人共有「<span style={{ color: '#8b0000' }}>2 次提問機會</span>」。若您暫無詢問方向，亦可點選對話框上方的<strong>快速發問標籤</strong>，請注意，<span style={{ color: '#8b0000' }}>快速發問同樣計入提問次數</span>。</p>
              <p>提問結束後，您有一些時間可以看一下對話紀錄，請依據所獲得的資訊，對該候選人給予 <span style={{ color: '#8b0000' }}>1 至 5 分</span>的評分。</p>
...
const QUICK_TAGS = [
  {
    label: '應徵者的年紀足以勝任嗎？',
    replies: [
      '我想想...嗯...陳O恩今年達成56 歲的高齡，屬於資深年齡層...吧？但就設計職位而言，年紀本身...應該會是設計產業的考量因素之一，嗯...我想應該無法跟上當代的潮流以及設計理念...的吧。',
      '林O今年 52 歲，恩...他的年紀算是偏高，而且應該...近年才正式轉職至設計領域...是吧？在轉職到這領域的適應力上，應該...也是會需要再做進一步的觀察。',
      '王O穎今年 30 歲，應該...正值職涯發展的黃金時期。我想...她足以勝任設計師一職吧！',
      '我想想...張O安今年 32 歲，年紀為適中，具備充足的職場能量與發展空間，我想...他應該足以勝任設計師一職吧...對吧？',
    ],
  },
  {
    label: '應徵者的年資足以勝任嗎？',
    replies: [
      '我想想...陳O恩今年達成12年的年資，屬於資深年齡層...吧。就設計職位而言，嗯...年資本身應該是設計產業的考量因素之一，可能...這代表應徵者會比較傾向固守原有的工作模式...吧？',
      '林O雖有多年廣告自營背景，但轉入正式設計職位僅約 2 年...吧？我想...正職設計年資相對較淺，應該...是需要再做進一步評估的。',
      '王O穎的整體資歷較為淺，嗯...但我想...在設計這方面應該具有豐富的想像力，應該...是非常適合這個產業的發展，足以勝任設計師一職吧。',
      '張O安擁有超過 10 年設計年資，並曾擔任平面設計總監，我想想...他應該是具備相當豐富的設計經驗，應當...是足以勝任的吧...對吧？',
    ],
  },
];
